...
public class RegisterPaypalActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_register_paypal);
    ...
    public void nextClick()
    {
        ...
        Call<PaymentStatusResponse> call = apiService.savePaymentMethod(GlobalData.userInfo.userId, "0", "paypal",
        ...
        call.enqueue(new Callback<PaymentStatusResponse>() {
            ...
            public void onFailure(Call<PaymentStatusResponse> call, Throwable t) {
                ...
                dlg_progress.dismiss();
                Toast.makeText(RegisterPaypalActivity.this, RegisterPaypalActivity.this.getText(R.string.connect_err), Toast.LENGTH_SHORT).show();
            }
        });
    }
